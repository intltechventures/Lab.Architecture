...
- Wikipedia 
  ...
  + https://en.wikipedia.org/wiki/Upper_ontology
    * Note: See ```Table of formal upper ontologies```
...
- ONTOLOG collaborative work environment - Historic Archives
  ...
  + https://ontologforum.com/index.php/WikiHomePage
    * (2015 - current)
  + https://groups.google.com/g/ontolog-forum?pli=1
    * (2015 - current) 
...
- Cyc
  ...
  + Obituary for the greatest monument to logical AGI (2025-04-01)
    * https://yuxi.ml/cyc/
...
- odp.org
  + Directory of Knowledge Representation Resources
    ...
    * http://www.odp.org/Reference/Knowledge_Management/Knowledge_Representation/Ontologies
...
- SUO-KIF
  + Standard Upper Ontology Knowledge Interchange Format (2009)
